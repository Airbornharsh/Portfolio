import { Audios } from "./musicDetails.js";
...
export class Audio {
    ...
    click() {
        ...
        this.next.addEventListener('click', this.nextAudio.bind(this));
        this.previous.addEventListener('click', this.previousAudio.bind(this));
